...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:15px;">
  <tr>
    <td valign="top"><div class="titlebg-left"></div><div class="titlebg titlebg-right"></div><div align="center" class="titlebg">' .$theme['title'] . '</div></td>
  </tr>
  <tr>
    <td valign="top"><div class="navbar-admin-top" align="center">
	<ul>';
