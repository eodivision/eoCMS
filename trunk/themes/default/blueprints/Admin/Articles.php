...
if(!isset($_GET['type']) || $_GET['type']==null) {
	...
	$theme['body'] = '<form action="" method="post" id="categories"><div class="admin-panel">'.theme('title', 'New Category').theme('start_content').'<table class="admin-table">
	  <tr>
	    <td>' . $ARTICLES_LANG["name"] . ':</td><td><input type="text" class="required" name="name" value="';
	if($check==false && isset($_POST['name'])) {
		$theme['body'] .= $_POST['name'];
	}
	$theme['body'] .= '"  /></td>
	  </tr>
	  <tr>
	...
	<table class="admin-table">
	  ...
	  <tr>
		...
		if($check==false && isset($_POST['summary'])) {
			$theme['body'].= $_POST['summary'];
		}
		$theme['body'] .= '</textarea></td>
	  </tr>
	  <tr>
...
if(isset($_GET['type']) && $_GET['type'] == 'edit') {
	...
	$theme['body'] = theme('breadcrumb', array('<a href="'.$settings['site_url'].'/index.php?act=admin&amp;opt=articles&amp;'.$authid.'">Articles</a>', $r['subject'])).'<form action="" method="post" id="articles"><div class="admin-panel">'.theme('title', $ARTICLES_LANG["edit_article"]).theme('start_content').'<table class="admin-table">
	  <tr>
	    <td>' . $ARTICLES_LANG["subject"] . ':</td>
	  </tr>
	  <tr>
...
if(isset($_GET['type']) && $_GET['type']=='editcategory') {
	...
	$theme['body'] = theme('breadcrumb', array('<a href="'.$settings['site_url'].'/index.php?act=admin&amp;opt=articles&amp;'.$authid.'">Articles</a>', 'Category', $fetch['name'])).'<form action="" method="post" id="categories"><div class="admin-panel">'.theme('title', $ARTICLES_LANG["edit_category"]).theme('start_content').'<table class="admin-table">
	  <tr>
