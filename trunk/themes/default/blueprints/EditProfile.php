...
$theme['title'] = $EDITPROFILE_LANG["title"];
$check = false;
$theme['body'] = theme('title', $EDITPROFILE_LANG["theme_title"]) . theme('start_content') . '<div id="editprofileLinks" class="editprofile-links" align="center">
...
$theme['body'] .= '<table id="profile" width="100%" class="profile-area">
<tr>
