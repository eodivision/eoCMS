...
$theme['title'] = $USERPREFERANCES_LANG["title"];
$check = false;
if ($user['guest']) {
...
if ($check == true && !errors()) {
	$theme['head'] = '<META HTTP-EQUIV="refresh" content="3;URL=' . $settings['site_url'] . '/index.php?act=userpreferances">';
...
$(document).ready(function() {
	...
	$theme['body'] = theme('title', $theme['title']) . theme('start_content') . '<form action="" method="post" id="admin">
<table>
	<tr>
