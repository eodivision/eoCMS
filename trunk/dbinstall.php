...
$sql = array('activation_keys' => array(
	...
	'columns' => array('token', 'expire_time', 'useragent', 'captcha_code', 'captcha_encode'),
	'types' => array('varchar(32)', 'int(10)', 'varchar(255)', 'varchar(32)', 'varchar(32)'),
	'keys' => array(
		'primary' => 'id',
		'auto_increment' => 'id'
	)
	...
	'columns' => array('topic_id', 'board_id', 'topic_title', 'topic_author', 'topic_author_id', 'topic_ip', 'date_created', 'locked', 'replies', 'latest_reply', 'sticky', 'views', 'hottopic'),
	'types' => array('int(255)', 'int(255)', 'varchar(225)', 'varchar(225)', 'int(255)', 'varchar(15)', 'varchar(225)', 'int(1) default \'0\'', 'int(255) default \'0\'', 'varchar(225) default \'0\'', 'int(1) default \'0\'', 'int(255) default \'0\'', 'int(1) default \'0\''),
	'keys' => array(
		'primary' => 'topic_id',
	...
	'columns' => array('ip', 'time', 'attempts'),
	'types' => array('text', 'int(10)', 'int(2)'),
), 'membergroups' => array(
	...
	'columns' => array('id', 'ssid', 'agent', 'user', 'pass', 'salt1', 'salt2', 'email', 'ip', 'regdate', 'lastlogin', 'membergroup', 'allow_login', 'posts', 'avatar', 'signature', 'location', 'birthday', 'show_email', 'msn', 'icq', 'yim', 'aim', 'offset', 'topics_page', 'posts_topic', 'quickreply', 'theme', 'gender', 'admin_menu', 'time_online'),
	'types' => array('int(255)', 'varchar(225)', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'int(11)', 'text', 'int(11) default "1"', 'int(11) default "1"', 'int(255) default "0"', 'text', 'text', 'varchar(225)', 'varchar(225)', 'varchar(1) default \'1\'', 'varchar(225)', 'varchar(225)', 'varchar(225)', 'varchar(225)', 'varchar(3)', 'tinyint(9)', 'tinyint(9)', 'tinyint(1)', 'varchar(225)', 'tinyint(1)', 'text', 'int(11)'),
	'keys' => array(
		'primary' => 'id',
		'auto_increment' => 'id'
	)
...
"INSERT INTO settings (id, variable, value, help_text) VALUES (28, 'version', '1.0.0', '{h_version}');", 
